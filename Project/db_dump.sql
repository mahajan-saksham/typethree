...
CREATE TABLE IF NOT EXISTS "public"."product_categories" (
    ...
    "icon_name" character varying(50) DEFAULT 'sun'::character varying NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"()
);
...
CREATE TABLE IF NOT EXISTS "public"."product_variants" (
    ...
    "subsidy_percentage" numeric DEFAULT 35 NOT NULL,
    "area_required" numeric NOT NULL,
    "monthly_savings" numeric NOT NULL,
    "installation_days" "text" DEFAULT '4-5'::"text" NOT NULL,
...
CREATE INDEX "idx_product_skus_category_id" ON "public"."product_skus" USING "btree" ("category_id");



CREATE INDEX "idx_product_variants_capacity" ON "public"."product_variants" USING "btree" ("capacity_kw");
...
CREATE INDEX "idx_product_variants_variant_sku" ON "public"."product_variants" USING "btree" ("variant_sku");
...
ALTER TABLE ONLY "public"."product_skus"
    ADD CONSTRAINT "product_skus_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."product_categories"("id");



ALTER TABLE ONLY "public"."product_variants"
    ADD CONSTRAINT "product_variants_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."product_skus"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins can manage product categories" ON "public"."product_categories" TO "authenticated" USING (("auth"."uid"() IN ( SELECT "user_profiles"."user_id"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."role" = 'admin'::"text"))));



CREATE POLICY "Admins can manage product variants" ON "public"."product_variants" TO "authenticated" USING (("auth"."uid"() IN ( SELECT "user_profiles"."user_id"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."role" = 'admin'::"text"))));



CREATE POLICY "Admins can manage products" ON "public"."product_skus" TO "authenticated" USING (("auth"."uid"() IN ( SELECT "user_profiles"."user_id"
   FROM "public"."user_profiles"
  WHERE ("user_profiles"."role" = 'admin'::"text"))));
...
CREATE POLICY "Anyone can view product categories" ON "public"."product_categories" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Anyone can view product variants" ON "public"."product_variants" FOR SELECT TO "authenticated", "anon" USING (true);



CREATE POLICY "Anyone can view products" ON "public"."product_skus" FOR SELECT TO "authenticated", "anon" USING (true);
