      ...
      <section className="py-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div
            ...
            style={{ background: 'url("/images/solar-pattern.svg") repeat' }}
          />
        ...
        <motion.div
          animate={{ opacity: [0.15, 0.25, 0.15], boxShadow: ["0 0 20px 1px rgba(204, 255, 0, 0.1)", "0 0 30px 2px rgba(204, 255, 0, 0.15)", "0 0 20px 1px rgba(204, 255, 0, 0.1)"] }}
          transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-10 right-20 w-60 h-40 bg-primary/10 border border-primary/10 opacity-20 rounded-md rotate-12"
        />
        <motion.div
      ...
      <section className="py-16 md:py-24 relative overflow-hidden" id="how-it-works">
        ...
        <div className="container mx-auto px-6 sm:px-6 max-w-6xl relative z-10">
          ...
          >
            ...
            >
              <span className="text-dark font-medium text-lg" style={{ textTransform: 'none' }}>Book Free Visit</span>
              <div>
      ...
      <section className="py-16 relative" id="calculator">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 20% 35%, rgba(204, 255, 0, 0.03) 0%, transparent 50%), radial-gradient(circle at 80% 65%, rgba(0, 180, 216, 0.03) 0%, transparent 55%)",
            }}
          />
          <div
            className="absolute top-0 right-0 w-full h-full opacity-5"
        ...
        <div className="container mx-auto px-6 sm:px-6 max-w-6xl relative z-10">
          ...
          >
            ...
            <p className="text-lg text-light/70 max-w-2xl mx-auto">
              See how much you can save with rooftop solar energy for your home
              or business. Adjust the system size to match your needs.
            </p>
          </motion.div>
                ...
                <div className="transition-all duration-300 border border-white/10 hover:border-primary/20 rounded-xl shadow-md p-6 md:p-8 relative z-10 flex flex-col flex-1 group-hover:shadow-xl">
                  <div className="flex items-center mb-6">
                    ...
                    <div className="space-y-0.5">
                      <h3 className="text-xl font-bold text-light mb-0.5">
                        System Specifications
                      </h3>
                      <p className="text-light/60 text-sm">
                        Customize your solar system size
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-8 flex-1 flex flex-col justify-between">
                    <div className="space-y-1">
                      <div className="flex justify-between items-center mb-3">
                        <label className="block text-base font-medium text-light">
                          Roof Size (kW)
                        </label>
                        <motion.span
                      ...
                      <div className="grid grid-cols-5 gap-3 py-3">
                        {[1, 2, 5, 10, 20].map((size) => (
                          <button
                            ...
                            className={`relative rounded-xl py-4 flex flex-col items-center justify-center transition-all duration-300 ${
                              roofSize === size
                    ...
                    <div className="transition-all duration-300 bg-white/5 border border-white/10 hover:border-primary/20 rounded-lg p-5 md:p-6 mt-auto shadow-lg shadow-dark/20">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                          <div className="text-sm font-medium text-light/70">
                            Average roof area needed:
                          </div>
                          <div>
                            <motion.span
                ...
                <div className="transition-all duration-300 border border-white/10 hover:border-primary/20 rounded-xl shadow-md p-6 md:p-8 relative z-10 flex flex-col flex-1 group-hover:shadow-xl">
                  <div className="flex items-center mb-6">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="text-light/60 text-sm">
                        Estimated savings with solar power
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 flex-1 flex flex-col justify-between">
                    ...
                    >
                      <p className="text-light/60 mb-1 text-sm">
                  ...
                  <div className="transition-all duration-300 border border-white/10 hover:border-primary/20 rounded-xl shadow-md p-6 md:p-8 relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-10">
                      ...
                      <div className="w-full md:w-1/3 lg:w-1/4 relative">
                        <div
                          className="transition-all duration-300 bg-white/5 border border-white/10 hover:border-white/20 rounded-lg overflow-hidden"
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 mt-6 mb-8">
                                ...
                                >
                                  ...
                                  <div>
                                    ...
                                    <div className="text-xl font-bold text-primary">
                                      {recommendedProduct.installation_days}{" "}
                                      Days
                                    </div>
                                  </div>
                                </motion.div>
      ...
      <section className="py-16 bg-dark-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "repeating-linear-gradient(0deg, transparent, transparent 40px, rgba(204, 255, 0, 0.1) 40px, rgba(204, 255, 0, 0.1) 41px), repeating-linear-gradient(90deg, transparent, transparent 40px, rgba(204, 255, 0, 0.1) 40px, rgba(204, 255, 0, 0.1) 41px)",
            }}
          ></div>
        </div>
          ...
          >
            ...
            >
              <div className="motion-card flex flex-col items-center gap-4 bg-gradient-to-br from-white/5 via-dark-800/80 to-dark-900/90 border border-white/10 rounded-2xl px-6 py-6 shadow-2xl backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 hover:border-primary/30 w-48 min-w-[12rem] justify-center text-center">
                ...
                <span className="text-light font-semibold text-sm md:text-base leading-[1.3] tracking-tight">
                  <span className="block">5-Year</span>
              ...
              <div className="motion-card flex flex-col items-center gap-4 bg-gradient-to-br from-white/5 via-dark-800/80 to-dark-900/90 border border-white/10 rounded-2xl px-6 py-6 shadow-2xl backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 hover:border-primary/30 w-48 min-w-[12rem] justify-center text-center">
                ...
                <span className="text-light font-semibold text-sm md:text-base leading-[1.3] tracking-tight">
                  ...
                  <span className="block">Satisfied Customers</span>
                </span>
              </div>
